...
// Fecha límite exacta: 10 de Diciembre de 2025 a las 23:59:59
export const FECHA_LIMITE_PREVENTA = new Date('2025-12-10T23:59:59'); 

// Datos informativos del evento para mostrar en el Portal
export const FECHA_EVENTO = "15 Diciembre 2025";
